...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            "controle_pav",
            "0015_remove_materialbase_equipe_materialbase_equipe700_and_more",
        ),
    ]

    operations = [
        migrations.RemoveField(model_name="materialbase", name="Equipe700",),
        migrations.RemoveField(model_name="materialbase", name="Equipe900",),
        migrations.RemoveField(model_name="materialbase", name="EquipeGestor",),
        migrations.AddField(
